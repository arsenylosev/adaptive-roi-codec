# Нейросетевой видеокодер с адаптивным распределением битрейта для капсульной эндоскопии

Нейросетевой видеокодер для капсульной эндоскопии с **адаптивным распределением битрейта** по клинически значимым областям интереса (ROI). Полное описание эксперимента для научной статьи: **[docs/opisanie-eksperimenta.md](docs/opisanie-eksperimenta.md)**.
